---
name: explainers
description: Write or continue an Explainer in a blog-craft blog whose config enables the explainers content-type. Walks a reader through one feature of a codebase, presents a Claude Skill, compares similar skills, or explains a cross-cutting concern. Use when creating or drafting a technical deep-dive post. Dormant unless content_types.explainers.enabled in .blog-craft.yaml.
---
